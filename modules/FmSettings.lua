...
function classes.FmSettings:Init()
    ...
    self.defaults = {
        ...
        itemFilter = {
			...
			[ITEMTYPE_FOOD] = {include=1},
			[ITEMTYPE_FURNISHING] = {include=1},
			[ITEMTYPE_FURNISHING_MATERIAL] = {include=1},
			[ITEMTYPE_GLYPH_ARMOR] = {include=1},
			[ITEMTYPE_GLYPH_JEWELRY] = {include=1},
			[ITEMTYPE_GLYPH_WEAPON] = {include=1},
			...
			[ITEMTYPE_TRASH] = {include=1},
			[ITEMTYPE_TREASURE] = {include=1},
			[ITEMTYPE_TROPHY] = {include=1},
			[ITEMTYPE_WEAPON] = {include=1},
